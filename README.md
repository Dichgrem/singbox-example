...
- 全自动安装All-in-one:
``wget https://raw.githubusercontent.com/Dichgrem/singbox-example/refs/heads/main/script/allinone.sh``,随后``bash ./allinone.sh``
...
- 配置转换：下载 [文件](https://github.com/Dichgrem/singbox-example/blob/main/tools/node_convert.html) 并使用浏览器打开即可，支持配置文件转json，json转配置文件以及配置文件转二维码.
